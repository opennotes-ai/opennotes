...
class ErrorCode(StrEnum):
    ...
    IMAGE_COUNT_TOO_LARGE = "image_count_too_large"
    IMAGE_AGGREGATE_TOO_LARGE = "image_aggregate_too_large"
...
class JobState(BaseModel):
    ...
    # Page metadata is stored on vibecheck_jobs. Keeping these top-level on
