...
> **Audience:** docs team scaffolding `opennotes-docs/` (TASK-1460) and anyone
> rebuilding the Mintlify site.
>
> **Status:** Integration spec — no wiring yet. Mintlify site does not exist at
> the time of writing (TASK-1460.01 is the gate).
>
> **Source of truth for tokens:** [`packages/tokens/`](../../packages/tokens/)
> in the `opennotes` submodule (package name: `@opennotes/tokens`).
