...
export interface paths {
    ...
    "/api/internal/analyses/recent-unfiltered": {
        ...
        /**
         * Internal unfiltered recent analyses gallery
         * @description Private read path for the prefix-guarded internal gallery.
         */
        get: operations["list_recent_analyses_unfiltered_api_internal_analyses_recent_unfiltered_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/feedback": {
        ...
        get?: never;
        put?: never;
        /** Open Or Combined Feedback */
        post: operations["open_or_combined_feedback_api_feedback_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/feedback/{feedback_id}": {
        ...
        head?: never;
        /** Submit Feedback */
        patch: operations["submit_feedback_api_feedback__feedback_id__patch"];
        trace?: never;
    };
    "/api/frame-compat": {
        parameters: {
...
export interface components {
    schemas: {
        ...
        FeedbackCombinedRequest: {
             ...
             * @enum {string}
             */
            initial_type: "thumbs_up" | "thumbs_down" | "message";
            /** Email */
            email?: string | null;
            /** Message */
            message?: string | null;
             ...
             * @enum {string}
             */
            final_type: "thumbs_up" | "thumbs_down" | "message";
        };
        /** FeedbackOpenRequest */
        FeedbackOpenRequest: {
            /**
...
export interface operations {
    ...
    list_recent_analyses_unfiltered_api_internal_analyses_recent_unfiltered_get: {
        parameters: {
            query?: {
                limit?: number;
            };
            header?: {
                "X-Internal-Prefix"?: string | null;
            };
            path?: never;
            cookie?: never;
        };
    ...
    open_or_combined_feedback_api_feedback_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["FeedbackOpenResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    submit_feedback_api_feedback__feedback_id__patch: {
        parameters: {
            query?: never;
            header?: never;
            path: {
