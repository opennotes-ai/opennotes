...
The OpenNotes plugin is installed as a Git clone inside the Discourse container. Upgrading means
...
Settings > Plugins > OpenNotes** and review any settings that now appear with their defaults.
