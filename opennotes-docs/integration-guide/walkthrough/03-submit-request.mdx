...
This is the core integration operation. Every piece of content that enters the Open Notes pipeline starts here.
...
Capture `data.id` — this is the Open Notes `request_id` UUID. You will need it to correlate incoming moderation actions in [Step 4](/integration-guide/walkthrough/04-handle-action).
