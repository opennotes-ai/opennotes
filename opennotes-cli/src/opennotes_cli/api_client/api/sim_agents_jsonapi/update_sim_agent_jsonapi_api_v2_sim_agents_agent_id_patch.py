...
from ...models.sim_agent_update_request import SimAgentUpdateRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v2/sim-agents/{agent_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SimAgentSingleResponse.from_dict(response.json())
