...
from ...models.note_publisher_config_list_response import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/note-publisher-configs",
        "params": params,
    }
...
) -> Any | HTTPValidationError | NotePublisherConfigListResponse | None:
    if response.status_code == 200:
        response_200 = NotePublisherConfigListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | HTTPValidationError | NotePublisherConfigListResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | HTTPValidationError | NotePublisherConfigListResponse
    """
