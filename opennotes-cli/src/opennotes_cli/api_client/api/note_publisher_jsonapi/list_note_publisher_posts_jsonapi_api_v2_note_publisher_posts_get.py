...
from ...models.note_publisher_post_list_response import NotePublisherPostListResponse
...
def _get_kwargs(
    *,
    ...
    filterchannel_id: None | str | Unset = UNSET,
    filtersuccess: bool | None | Unset = UNSET,
    ...
    json_filterchannel_id: None | str | Unset
    if isinstance(filterchannel_id, Unset):
        json_filterchannel_id = UNSET
    else:
        json_filterchannel_id = filterchannel_id
    params["filter[channel_id]"] = json_filterchannel_id

    json_filtersuccess: bool | None | Unset
    if isinstance(filtersuccess, Unset):
        json_filtersuccess = UNSET
    else:
        json_filtersuccess = filtersuccess
    params["filter[success]"] = json_filtersuccess
...
) -> Any | HTTPValidationError | NotePublisherPostListResponse | None:
    if response.status_code == 200:
        response_200 = NotePublisherPostListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | HTTPValidationError | NotePublisherPostListResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        filterchannel_id (None | str | Unset):
        filtersuccess (bool | None | Unset):
    ...
    kwargs = _get_kwargs(
        ...
        filterchannel_id=filterchannel_id,
...
def sync(
    *,
    ...
    Returns:
        Any | HTTPValidationError | NotePublisherPostListResponse
    """
