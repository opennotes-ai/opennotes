...
from ...models.note_publisher_config_create_request import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = NotePublisherConfigSingleResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (NotePublisherConfigCreateRequest): JSON:API request body for creating a config.
