...
from ...models.batch_job_create import BatchJobCreate
...
def sync_detailed(
    *,
    ...
    """Create a new batch job
     ...
     Create a new batch job entry. The job starts in PENDING status. Use this to register a job before
    dispatching tasks.

    Args:
        x_api_key (None | str | Unset):
        body (BatchJobCreate): Schema for creating a new batch job.
