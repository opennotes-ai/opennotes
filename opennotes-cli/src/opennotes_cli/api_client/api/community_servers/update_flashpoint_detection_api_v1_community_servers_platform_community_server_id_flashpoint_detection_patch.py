...
from ...models.flashpoint_detection_update_request import (
    FlashpointDetectionUpdateRequest,
)
from ...models.flashpoint_detection_update_response import (
...
def _get_kwargs(
    ...
    *,
    body: FlashpointDetectionUpdateRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/community-servers/{platform_community_server_id}/flashpoint-detection".format(
...
) -> Any | FlashpointDetectionUpdateResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = FlashpointDetectionUpdateResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | FlashpointDetectionUpdateResponse | HTTPValidationError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (FlashpointDetectionUpdateRequest): Request model for updating flashpoint detection
            setting.
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | FlashpointDetectionUpdateResponse | HTTPValidationError
    """
