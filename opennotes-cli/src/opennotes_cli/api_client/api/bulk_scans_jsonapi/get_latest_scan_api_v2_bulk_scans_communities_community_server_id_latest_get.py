...
from ...models.latest_scan_jsonapi_response import LatestScanJSONAPIResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/bulk-scans/communities/{community_server_id}/latest".format(
...
) -> Any | HTTPValidationError | LatestScanJSONAPIResponse | None:
    if response.status_code == 200:
        response_200 = LatestScanJSONAPIResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | HTTPValidationError | LatestScanJSONAPIResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | HTTPValidationError | LatestScanJSONAPIResponse
    """
