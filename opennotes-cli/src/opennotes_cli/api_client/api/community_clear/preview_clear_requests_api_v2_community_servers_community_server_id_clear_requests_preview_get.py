...
from ...models.clear_preview_response import ClearPreviewResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/community-servers/{community_server_id}/clear-requests/preview".format(
...
) -> Any | ClearPreviewResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = ClearPreviewResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ClearPreviewResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | ClearPreviewResponse | HTTPValidationError
    """
