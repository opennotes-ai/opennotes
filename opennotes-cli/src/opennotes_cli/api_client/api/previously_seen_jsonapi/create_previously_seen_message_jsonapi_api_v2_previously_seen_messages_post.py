...
from ...models.previously_seen_message_create_request import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = PreviouslySeenMessageSingleResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (PreviouslySeenMessageCreateRequest): JSON:API request body for creating a previously
            seen message.
