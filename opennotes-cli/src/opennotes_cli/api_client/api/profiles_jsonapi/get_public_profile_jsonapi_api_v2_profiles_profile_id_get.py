...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/profiles/{profile_id}".format(
...
) -> HTTPValidationError | ProfileSingleResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ProfileSingleResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | ProfileSingleResponse
    """
