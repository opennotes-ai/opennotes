...
T = TypeVar("T", bound="BodyLoginEmailApiV1ProfileAuthLoginEmailPost")


@_attrs_define
class BodyLoginEmailApiV1ProfileAuthLoginEmailPost:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_login_email_api_v1_profile_auth_login_email_post = cls(
            username=username,
            password=password,
        ...
        body_login_email_api_v1_profile_auth_login_email_post.additional_properties = d
        return body_login_email_api_v1_profile_auth_login_email_post
