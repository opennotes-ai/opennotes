...
if TYPE_CHECKING:
    from ..models.admin_status_resource import AdminStatusResource
    from ..models.admin_status_single_response_jsonapi import (
        AdminStatusSingleResponseJsonapi,
    )
    from ..models.jsonapi_links import JSONAPILinks


T = TypeVar("T", bound="AdminStatusSingleResponse")


@_attrs_define
class AdminStatusSingleResponse:
    """JSON:API response for admin status resource.

    Attributes:
        data (AdminStatusResource): JSON:API resource object for admin status.
        jsonapi (AdminStatusSingleResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
    """

    data: AdminStatusResource
    jsonapi: AdminStatusSingleResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = AdminStatusResource.from_dict(d.pop("data"))
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = AdminStatusSingleResponseJsonapi.from_dict(_jsonapi)
        ...
        admin_status_single_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
        )

        admin_status_single_response.additional_properties = d
        return admin_status_single_response
