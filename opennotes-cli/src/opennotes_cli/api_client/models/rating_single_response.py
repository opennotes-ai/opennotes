...
if TYPE_CHECKING:
    ...
    from ..models.rating_single_response_jsonapi import RatingSingleResponseJsonapi


T = TypeVar("T", bound="RatingSingleResponse")


@_attrs_define
class RatingSingleResponse:
    """JSON:API response for a single rating resource.

    Attributes:
        data (RatingResource): JSON:API resource object for a rating.
        jsonapi (RatingSingleResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
    """

    data: RatingResource
    jsonapi: RatingSingleResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = RatingResource.from_dict(d.pop("data"))
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = RatingSingleResponseJsonapi.from_dict(_jsonapi)
        ...
        rating_single_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
        )

        rating_single_response.additional_properties = d
        return rating_single_response
