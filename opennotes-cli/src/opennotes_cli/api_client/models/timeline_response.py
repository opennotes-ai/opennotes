...
if TYPE_CHECKING:
    from ..models.timeline_resource import TimelineResource
    from ..models.timeline_response_jsonapi import TimelineResponseJsonapi
...
class TimelineResponse:
    ...
    Attributes:
        ...
        jsonapi (TimelineResponseJsonapi | Unset):
    """

    data: TimelineResource
    jsonapi: TimelineResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = TimelineResource.from_dict(d.pop("data"))
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = TimelineResponseJsonapi.from_dict(_jsonapi)
