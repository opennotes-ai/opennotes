...
if TYPE_CHECKING:
    ...
    from ..models.profile_resource import ProfileResource
    from ..models.profile_single_response_jsonapi import ProfileSingleResponseJsonapi


T = TypeVar("T", bound="ProfileSingleResponse")


@_attrs_define
class ProfileSingleResponse:
    """JSON:API response for a single profile resource.

    Attributes:
        data (ProfileResource): JSON:API resource object for a profile.
        jsonapi (ProfileSingleResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
    """

    data: ProfileResource
    jsonapi: ProfileSingleResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.jsonapi_links import JSONAPILinks
        from ..models.profile_resource import ProfileResource
        from ..models.profile_single_response_jsonapi import (
            ProfileSingleResponseJsonapi,
        )

        d = dict(src_dict)
        data = ProfileResource.from_dict(d.pop("data"))
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = ProfileSingleResponseJsonapi.from_dict(_jsonapi)
        ...
        profile_single_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
        )

        profile_single_response.additional_properties = d
        return profile_single_response
