...
if TYPE_CHECKING:
    ...
    from ..models.note_resource import NoteResource
    from ..models.note_single_response_jsonapi import NoteSingleResponseJsonapi


T = TypeVar("T", bound="NoteSingleResponse")


@_attrs_define
class NoteSingleResponse:
    """JSON:API response for a single note resource.

    Attributes:
        data (NoteResource): JSON:API resource object for a note.
        jsonapi (NoteSingleResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
    """

    data: NoteResource
    jsonapi: NoteSingleResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = NoteResource.from_dict(d.pop("data"))
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = NoteSingleResponseJsonapi.from_dict(_jsonapi)
        ...
        note_single_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
        )

        note_single_response.additional_properties = d
        return note_single_response
