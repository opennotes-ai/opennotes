...
if TYPE_CHECKING:
    ...
    from ..models.rating_stats_resource import RatingStatsResource
    from ..models.rating_stats_single_response_jsonapi import (
        RatingStatsSingleResponseJsonapi,
    )


T = TypeVar("T", bound="RatingStatsSingleResponse")


@_attrs_define
class RatingStatsSingleResponse:
    """JSON:API response for rating statistics.

    Attributes:
        data (RatingStatsResource): JSON:API resource object for rating statistics.
        jsonapi (RatingStatsSingleResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
    """

    data: RatingStatsResource
    jsonapi: RatingStatsSingleResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = RatingStatsResource.from_dict(d.pop("data"))
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = RatingStatsSingleResponseJsonapi.from_dict(_jsonapi)
        ...
        rating_stats_single_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
        )

        rating_stats_single_response.additional_properties = d
        return rating_stats_single_response
