...
if TYPE_CHECKING:
    ...
    from ..models.similarity_search_result_resource import (
        SimilaritySearchResultResource,
    )
    from ..models.similarity_search_result_response_jsonapi import (
        SimilaritySearchResultResponseJsonapi,
    )


T = TypeVar("T", bound="SimilaritySearchResultResponse")


@_attrs_define
class SimilaritySearchResultResponse:
    """JSON:API response for similarity search results.

    Attributes:
        data (SimilaritySearchResultResource): JSON:API resource object for similarity search results.
        jsonapi (SimilaritySearchResultResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
    """

    data: SimilaritySearchResultResource
    jsonapi: SimilaritySearchResultResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = SimilaritySearchResultResource.from_dict(d.pop("data"))
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = SimilaritySearchResultResponseJsonapi.from_dict(_jsonapi)
        ...
        similarity_search_result_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
        )

        similarity_search_result_response.additional_properties = d
        return similarity_search_result_response
