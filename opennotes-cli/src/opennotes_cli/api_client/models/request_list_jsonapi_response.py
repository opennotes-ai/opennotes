...
if TYPE_CHECKING:
    ...
    from ..models.request_list_jsonapi_response_jsonapi import (
        RequestListJSONAPIResponseJsonapi,
    )
    from ..models.request_resource import RequestResource


T = TypeVar("T", bound="RequestListJSONAPIResponse")


@_attrs_define
class RequestListJSONAPIResponse:
    """JSON:API response for a list of request resources.

    Attributes:
        data (list[RequestResource]):
        jsonapi (RequestListJSONAPIResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
        meta (JSONAPIMeta | None | Unset):
    """

    data: list[RequestResource]
    jsonapi: RequestListJSONAPIResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = RequestResource.from_dict(data_item_data)
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = RequestListJSONAPIResponseJsonapi.from_dict(_jsonapi)
        ...
        request_list_jsonapi_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
            meta=meta,
        ...
        request_list_jsonapi_response.additional_properties = d
        return request_list_jsonapi_response
