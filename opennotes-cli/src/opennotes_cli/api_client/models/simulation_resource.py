...
if TYPE_CHECKING:
    from ..models.simulation_attributes import SimulationAttributes
...
class SimulationResource:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attributes = SimulationAttributes.from_dict(d.pop("attributes"))
        ...
        simulation_resource.additional_properties = d
