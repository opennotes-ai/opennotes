...
if TYPE_CHECKING:
    ...
    from ..models.sim_agent_list_response_jsonapi import SimAgentListResponseJsonapi
    from ..models.sim_agent_resource import SimAgentResource


T = TypeVar("T", bound="SimAgentListResponse")


@_attrs_define
class SimAgentListResponse:
    """
    Attributes:
        data (list[SimAgentResource]):
        jsonapi (SimAgentListResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
        meta (JSONAPIMeta | None | Unset):
    """

    data: list[SimAgentResource]
    jsonapi: SimAgentListResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = SimAgentResource.from_dict(data_item_data)
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = SimAgentListResponseJsonapi.from_dict(_jsonapi)
        ...
        sim_agent_list_response.additional_properties = d
        return sim_agent_list_response
