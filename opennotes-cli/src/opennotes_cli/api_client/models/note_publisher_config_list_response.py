...
if TYPE_CHECKING:
    ...
    from ..models.note_publisher_config_list_response_jsonapi import (
        NotePublisherConfigListResponseJsonapi,
    )
    from ..models.note_publisher_config_resource import NotePublisherConfigResource


T = TypeVar("T", bound="NotePublisherConfigListResponse")


@_attrs_define
class NotePublisherConfigListResponse:
    """JSON:API response for a list of config resources.

    Attributes:
        data (list[NotePublisherConfigResource]):
        jsonapi (NotePublisherConfigListResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
        meta (JSONAPIMeta | None | Unset):
    """

    data: list[NotePublisherConfigResource]
    jsonapi: NotePublisherConfigListResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = NotePublisherConfigResource.from_dict(data_item_data)
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = NotePublisherConfigListResponseJsonapi.from_dict(_jsonapi)
        ...
        note_publisher_config_list_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
            meta=meta,
        ...
        note_publisher_config_list_response.additional_properties = d
        return note_publisher_config_list_response
