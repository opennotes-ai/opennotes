...
if TYPE_CHECKING:
    ...
    from ..models.simulation_list_response_jsonapi import SimulationListResponseJsonapi
...
class SimulationListResponse:
    ...
    Attributes:
        ...
        jsonapi (SimulationListResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
        meta (JSONAPIMeta | None | Unset):
    """

    data: list[SimulationResource]
    jsonapi: SimulationListResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.jsonapi_links import JSONAPILinks
        from ..models.jsonapi_meta import JSONAPIMeta
        from ..models.simulation_list_response_jsonapi import (
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = SimulationListResponseJsonapi.from_dict(_jsonapi)
        ...
        simulation_list_response.additional_properties = d
