...
if TYPE_CHECKING:
    ...
    from ..models.simulation_resource import SimulationResource
    from ..models.simulation_single_response_jsonapi import (
        SimulationSingleResponseJsonapi,
    )


T = TypeVar("T", bound="SimulationSingleResponse")


@_attrs_define
class SimulationSingleResponse:
    """
    Attributes:
        data (SimulationResource):
        jsonapi (SimulationSingleResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
    """

    data: SimulationResource
    jsonapi: SimulationSingleResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = SimulationResource.from_dict(d.pop("data"))
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = SimulationSingleResponseJsonapi.from_dict(_jsonapi)
        ...
        simulation_single_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
        )

        simulation_single_response.additional_properties = d
        return simulation_single_response
