...
if TYPE_CHECKING:
    from ..models.simulation_update_attributes import SimulationUpdateAttributes


T = TypeVar("T", bound="SimulationUpdateData")
...
class SimulationUpdateData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attributes = SimulationUpdateAttributes.from_dict(d.pop("attributes"))

        simulation_update_data = cls(
            type_=type_,
            attributes=attributes,
        )

        return simulation_update_data
