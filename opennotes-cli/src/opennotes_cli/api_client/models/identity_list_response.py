...
if TYPE_CHECKING:
    from ..models.identity_list_response_jsonapi import IdentityListResponseJsonapi
...
class IdentityListResponse:
    ...
    Attributes:
        ...
        jsonapi (IdentityListResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
        meta (JSONAPIMeta | None | Unset):
    """

    data: list[IdentityResource]
    jsonapi: IdentityListResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = IdentityResource.from_dict(data_item_data)
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = IdentityListResponseJsonapi.from_dict(_jsonapi)
