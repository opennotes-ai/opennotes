...
if TYPE_CHECKING:
    from ..models.explanation_result_resource import ExplanationResultResource
    from ..models.explanation_result_response_jsonapi import (
        ExplanationResultResponseJsonapi,
    )
    from ..models.jsonapi_links import JSONAPILinks


T = TypeVar("T", bound="ExplanationResultResponse")


@_attrs_define
class ExplanationResultResponse:
    """JSON:API response for explanation generation.

    Attributes:
        data (ExplanationResultResource): JSON:API resource for explanation result.
        jsonapi (ExplanationResultResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
    """

    data: ExplanationResultResource
    jsonapi: ExplanationResultResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = ExplanationResultResource.from_dict(d.pop("data"))
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = ExplanationResultResponseJsonapi.from_dict(_jsonapi)
        ...
        explanation_result_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
        )

        explanation_result_response.additional_properties = d
        return explanation_result_response
