...
if TYPE_CHECKING:
    ...
    from ..models.note_publisher_post_list_response_jsonapi import (
        NotePublisherPostListResponseJsonapi,
    )
    from ..models.note_publisher_post_resource import NotePublisherPostResource


T = TypeVar("T", bound="NotePublisherPostListResponse")


@_attrs_define
class NotePublisherPostListResponse:
    """JSON:API response for a list of post resources.

    Attributes:
        data (list[NotePublisherPostResource]):
        jsonapi (NotePublisherPostListResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
        meta (JSONAPIMeta | None | Unset):
    """

    data: list[NotePublisherPostResource]
    jsonapi: NotePublisherPostListResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = NotePublisherPostResource.from_dict(data_item_data)
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = NotePublisherPostListResponseJsonapi.from_dict(_jsonapi)
        ...
        note_publisher_post_list_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
            meta=meta,
        ...
        note_publisher_post_list_response.additional_properties = d
        return note_publisher_post_list_response
