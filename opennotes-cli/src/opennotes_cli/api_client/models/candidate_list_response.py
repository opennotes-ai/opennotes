...
if TYPE_CHECKING:
    from ..models.candidate_list_response_jsonapi import CandidateListResponseJsonapi
...
T = TypeVar("T", bound="CandidateListResponse")
...
class CandidateListResponse:
    ...
    Attributes:
        ...
        jsonapi (CandidateListResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
        meta (JSONAPIMeta | None | Unset):
    """

    data: list[CandidateResource]
    jsonapi: CandidateListResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.candidate_list_response_jsonapi import (
        ...
        for data_item_data in _data:
            data_item = CandidateResource.from_dict(data_item_data)
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = CandidateListResponseJsonapi.from_dict(_jsonapi)
        ...
        candidate_list_response.additional_properties = d
