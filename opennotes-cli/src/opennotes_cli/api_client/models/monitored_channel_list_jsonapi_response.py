...
if TYPE_CHECKING:
    ...
    from ..models.monitored_channel_list_jsonapi_response_jsonapi import (
        MonitoredChannelListJSONAPIResponseJsonapi,
    )
    from ..models.monitored_channel_resource import MonitoredChannelResource


T = TypeVar("T", bound="MonitoredChannelListJSONAPIResponse")


@_attrs_define
class MonitoredChannelListJSONAPIResponse:
    """JSON:API response for a list of monitored channel resources.

    Attributes:
        data (list[MonitoredChannelResource]):
        jsonapi (MonitoredChannelListJSONAPIResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
        meta (JSONAPIMeta | None | Unset):
    """

    data: list[MonitoredChannelResource]
    jsonapi: MonitoredChannelListJSONAPIResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = MonitoredChannelResource.from_dict(data_item_data)
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = MonitoredChannelListJSONAPIResponseJsonapi.from_dict(_jsonapi)
        ...
        monitored_channel_list_jsonapi_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
            meta=meta,
        ...
        monitored_channel_list_jsonapi_response.additional_properties = d
        return monitored_channel_list_jsonapi_response
