...
if TYPE_CHECKING:
    ...
    from ..models.orchestrator_resource import OrchestratorResource
    from ..models.orchestrator_single_response_jsonapi import (
        OrchestratorSingleResponseJsonapi,
    )


T = TypeVar("T", bound="OrchestratorSingleResponse")


@_attrs_define
class OrchestratorSingleResponse:
    """
    Attributes:
        data (OrchestratorResource):
        jsonapi (OrchestratorSingleResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
    """

    data: OrchestratorResource
    jsonapi: OrchestratorSingleResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = OrchestratorResource.from_dict(d.pop("data"))
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = OrchestratorSingleResponseJsonapi.from_dict(_jsonapi)
        ...
        orchestrator_single_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
        )

        orchestrator_single_response.additional_properties = d
        return orchestrator_single_response
