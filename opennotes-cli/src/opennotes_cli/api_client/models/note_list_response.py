...
if TYPE_CHECKING:
    ...
    from ..models.note_list_response_jsonapi import NoteListResponseJsonapi
    from ..models.note_resource import NoteResource


T = TypeVar("T", bound="NoteListResponse")
...
class NoteListResponse:
    ...
    Attributes:
        ...
        jsonapi (NoteListResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
        meta (JSONAPIMeta | None | Unset):
    """

    data: list[NoteResource]
    jsonapi: NoteListResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = NoteResource.from_dict(data_item_data)
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = NoteListResponseJsonapi.from_dict(_jsonapi)
        ...
        note_list_response.additional_properties = d
        return note_list_response
