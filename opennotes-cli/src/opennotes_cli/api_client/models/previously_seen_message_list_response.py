...
if TYPE_CHECKING:
    ...
    from ..models.previously_seen_message_list_response_jsonapi import (
...
T = TypeVar("T", bound="PreviouslySeenMessageListResponse")


@_attrs_define
class PreviouslySeenMessageListResponse:
    """JSON:API response for a list of previously seen message resources.

    Attributes:
        data (list[PreviouslySeenMessageResource]):
        jsonapi (PreviouslySeenMessageListResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
        meta (JSONAPIMeta | None | Unset):
    """

    data: list[PreviouslySeenMessageResource]
    jsonapi: PreviouslySeenMessageListResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = PreviouslySeenMessageResource.from_dict(data_item_data)
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = PreviouslySeenMessageListResponseJsonapi.from_dict(_jsonapi)
        ...
        previously_seen_message_list_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
            meta=meta,
        ...
        previously_seen_message_list_response.additional_properties = d
        return previously_seen_message_list_response
