...
if TYPE_CHECKING:
    from ..models.community_membership_list_response_jsonapi import (
        CommunityMembershipListResponseJsonapi,
    )
    from ..models.community_membership_resource import CommunityMembershipResource
    from ..models.jsonapi_links import JSONAPILinks
    from ..models.jsonapi_meta import JSONAPIMeta


T = TypeVar("T", bound="CommunityMembershipListResponse")


@_attrs_define
class CommunityMembershipListResponse:
    """JSON:API response for a list of community membership resources.

    Attributes:
        data (list[CommunityMembershipResource]):
        jsonapi (CommunityMembershipListResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
        meta (JSONAPIMeta | None | Unset):
    """

    data: list[CommunityMembershipResource]
    jsonapi: CommunityMembershipListResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = CommunityMembershipResource.from_dict(data_item_data)
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = CommunityMembershipListResponseJsonapi.from_dict(_jsonapi)
        ...
        community_membership_list_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
            meta=meta,
        ...
        community_membership_list_response.additional_properties = d
        return community_membership_list_response
