...
if TYPE_CHECKING:
    ...
    from ..models.sim_agent_resource import SimAgentResource
    from ..models.sim_agent_single_response_jsonapi import SimAgentSingleResponseJsonapi


T = TypeVar("T", bound="SimAgentSingleResponse")


@_attrs_define
class SimAgentSingleResponse:
    """
    Attributes:
        data (SimAgentResource):
        jsonapi (SimAgentSingleResponseJsonapi | Unset):
        links (JSONAPILinks | None | Unset):
    """

    data: SimAgentResource
    jsonapi: SimAgentSingleResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.jsonapi_links import JSONAPILinks
        from ..models.sim_agent_resource import SimAgentResource
        from ..models.sim_agent_single_response_jsonapi import (
            SimAgentSingleResponseJsonapi,
        )

        d = dict(src_dict)
        data = SimAgentResource.from_dict(d.pop("data"))
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = SimAgentSingleResponseJsonapi.from_dict(_jsonapi)
        ...
        sim_agent_single_response = cls(
            data=data,
            jsonapi=jsonapi,
            links=links,
        )

        sim_agent_single_response.additional_properties = d
        return sim_agent_single_response
