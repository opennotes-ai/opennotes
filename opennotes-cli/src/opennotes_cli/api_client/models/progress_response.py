...
if TYPE_CHECKING:
    from ..models.progress_resource import ProgressResource
    from ..models.progress_response_jsonapi import ProgressResponseJsonapi
...
class ProgressResponse:
    ...
    Attributes:
        ...
        jsonapi (ProgressResponseJsonapi | Unset):
    """

    data: ProgressResource
    jsonapi: ProgressResponseJsonapi | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = ProgressResource.from_dict(d.pop("data"))
        ...
        if isinstance(_jsonapi, Unset):
            ...
            jsonapi = ProgressResponseJsonapi.from_dict(_jsonapi)
