...
T = TypeVar("T", bound="BodyLoginApiV1AuthLoginPost")
...
class BodyLoginApiV1AuthLoginPost:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_login_api_v1_auth_login_post = cls(
            username=username,
            password=password,
        ...
        body_login_api_v1_auth_login_post.additional_properties = d
        return body_login_api_v1_auth_login_post
