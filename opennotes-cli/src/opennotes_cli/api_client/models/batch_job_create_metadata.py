...
T = TypeVar("T", bound="BatchJobCreateMetadata")


@_attrs_define
class BatchJobCreateMetadata:
    """Job-specific metadata (e.g., source file, options)"""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_job_create_metadata.additional_properties = additional_properties
        return batch_job_create_metadata
