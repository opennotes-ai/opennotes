...
class AINoteWriter:
    ...
    async def generate_note_for_request(self, db: AsyncSession, request_id: UUID) -> Note:
        """
        ...
        try:
            ...
            ai_note_generation_duration_seconds.record(
                duration, {"community_server_id": community_server_id_str}
            )
