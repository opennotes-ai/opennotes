...
def chunk_and_embed_fact_check_sync(
    ...
    from src.fact_checking.chunk_embedding_service import ChunkEmbeddingService  # noqa: PLC0415
    from src.fact_checking.chunking_service import ChunkingService  # noqa: PLC0415
    from src.llm_config.encryption import EncryptionService  # noqa: PLC0415
    from src.llm_config.manager import LLMClientManager  # noqa: PLC0415
    from src.llm_config.service import LLMService  # noqa: PLC0415
